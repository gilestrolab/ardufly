...
class mySQLDatabase():
    ...
    def __init__(self, db_credentials):
        _db_name = db_credentials["db_name"]
        _db_user_name = db_credentials["username"]
        _db_user_pass = db_credentials["password"]
        
        from MySQLdb.constants import FIELD_TYPE
        my_conv = { FIELD_TYPE.TIMESTAMP: str }
        
        self.connection = MySQLdb.connect('localhost', _db_user_name, _db_user_pass, _db_name, conv=my_conv)
